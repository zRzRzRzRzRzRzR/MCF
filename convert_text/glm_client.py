...
修正后："""
    ...
    def batch_detect_and_correct_segments(self, segments: List[Dict]) -> List[Dict]:
        ...
        print(f"  Quick fixes: {quick_fix_count}, Pre-filter skipped: {pre_filter_count}")
        ...
        print(f"Batch processing completed! Total corrections: {total_corrections}, API corrections: {api_corrections}")
    ...
    def _batch_api_process(self, texts: List[str]) -> List[Dict]:
        ...
        for i in range(0, len(texts), self.batch_size):
            ...
            print(f"    Processing batch {i//self.batch_size + 1}, segments: {len(batch)}")
