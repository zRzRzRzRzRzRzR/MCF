...
def main():
    parser = argparse.ArgumentParser(description="Convert MP4 video file to MP3 audio file")
    parser.add_argument("input", help="Input MP4 file path")
    parser.add_argument("-o", "--output", help="Output MP3 file path (optional, defaults to same directory with .mp3 extension)")
