...
def process_folder(
    ...
    try:
        ...
        for match in matches:
            ...
            results.append(
                {"speaker": speaker, "timestamp": timestamp, "emotion": emotion.strip()}
            )
...
def main():
    parser = argparse.ArgumentParser(
        description="Batch process chat folders for emotion analysis"
    )
    parser.add_argument(
        "--root_dir",
        type=str,
        required=True,
        help="Root directory containing chat-<number> folders",
    )
    parser.add_argument(
    ...
    parser.add_argument(
        ...
        type=str,
        default="video_audio",
        choices=["video_audio", "audio", "video"],
    ...
    parser.add_argument(
        "--model_path",
        type=str,
        default="/root/.cache/modelscope/hub/models/iic/R1-Omni-0.5B",
